...
// 				{name: "col2", queue: true, label: "Done", cfdLabel: "Analysis Done", cfdShortLabel: "An Done"},
				...
				{name: "col7", queue: false, label: "Deployment", cfdLabel: "Deployment", cfdShortLabel: "Depl"},
				{name: "col8", queue: true, label: "Done", cfdLabel: "Done", cfdShortLabel: "Done", ignoreLimit: true},
