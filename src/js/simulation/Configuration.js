    ...
    this.data = {
        ...
        columns: {
            ...
            definitions: [
                ...
                {name: "col1", queue: false, label: "Doing", cfdLabel: "Analysis", reducesComplexity: false},
                {name: "col2", queue: true, label: "Done", cfdLabel: "Analysis Done"},
                {name: "col3", queue: false, label: "Doing", cfdLabel: "Development", reducesComplexity: false},
                {name: "col4", queue: true, label: "Done", cfdLabel: "Development Done"},
                {name: "col5", queue: false, label: "Doing", cfdLabel: "QA", reducesComplexity: true},
                {name: "col6", queue: true, label: "Done", cfdLabel: "QA Done"},
                {name: "col7", queue: false, label: "Deployment", cfdLabel: "Deployment", reducesComplexity: false},
